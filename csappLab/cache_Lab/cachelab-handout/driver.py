...
def main():
    ...
    stdout_data = stdout_data.decode('utf-8')  # Add this line
    ...
    csim_cscore = list(map(int, resultsim))  # Modify this line
    ...
    print ("\nCache Lab summary:")
    print ("%-22s%8s%10s%12s" % ("", "Points", "Max pts", "Misses"))  # Modify this line
    print ("%-22s%8.1f%10d" % ("Csim correctness", csim_cscore[0], 0))  # Modify this line


    misses = str(miss32)
    if miss32 == 2**31-1 :
        misses = "invalid"
    print ("%-22s%8.1f%10d%12s" % ("Trans perf 32x32", trans32_score, 0, ""))  # Modify this line
    ...
    if miss64 == 2**31-1 :
        misses = "invalid"
    print ("%-22s%8.1f%10d%12s" % ("Trans perf 64x64", trans64_score, 0, ""))  # Modify this line


    misses = str(miss61)
    if miss61 == 2**31-1 :
        misses = "invalid"
    print ("%-22s%8.1f%10d%12s" % ("Trans perf 61x67", trans61_score, maxscore['trans61'], misses))  # Modify this line

    print ("%22s%8.1f%10d" % ("Total points", total_score, maxscore['csim'] + maxscore['trans32'] + maxscore['trans64'] + maxscore['trans61']))  # Modify this line
